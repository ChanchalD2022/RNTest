...
function App() {
  ...
  async function connectMagicEthereum() {
    magic = new Magic("pk_live_C831F1C9223202CE");
    ...
    <div className="App">
      <header className="App-header">
        ...
        <div>
          ...
          <h3>Workaround</h3>
          <br></br>
          You can make a test purchase without having to connect your own
          payment method (staging environments only): <br />
          <p>
            <ol>
              <li>
                Add a new payment method, select "Manual Bank Transfer" (switch
                country to any European country if your country doesn't have
                that option).
              </li>
              <br />
              <li>
                You should be back to the confirmation screen with "Any currency
                account" manual bank transfer payment method selected.
              </li>{" "}
              <br />
              <li> Continue, the purchase will be created.</li>
              <br />
              <li>
                {" "}
                Tick the box that says that you've transferred the funds and
                continue.
              </li>{" "}
              <br />
              <li>Open the transaction summary link.</li> <br />
              <li>
                Click the manual test release button at the bottom of the
                summary and wait a few moments until the confirmation is
                processed.
              </li>
            </ol>
          </p>
